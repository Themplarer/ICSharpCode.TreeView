...
public class SharpTreeView : ItemsRepeater
{
    static SharpTreeView() => RegisterCommands();
            ...
            switch (e.Key)
            {
                ...
                case Key.Return:
                    if (container != null &&
                        ...
                        this.SelectedItem == container.Node)
                    {
    ...
    protected override void OnTextInput(TextCompositionEventArgs e)
    {
        if (!string.IsNullOrEmpty(e.Text) &&
            IsTextSearchEnabled &&
            (e.OriginalSource == this || ItemsControl.ItemsControlFromItemContainer(e.OriginalSource as DependencyObject) == this))
        {
            var instance = SharpTreeViewTextSearch.GetInstance(this);
